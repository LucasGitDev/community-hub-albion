...
PR: https://github.com/LucasGitDev/community-hub-albion/pull/43 — run 35097228696, **9/9 checks pass**: lint, typecheck, coverage, duplication, deadcode, audit, e2e (2m16s), image e **summary**. O e2e passa no runner limpo, confirmando que as falhas locais eram do ambiente (máquina carregada com o worktree da task-037 em paralelo) e não regressão — reproduzidas iguais em origin/main como controle. DoD#1 marcado com base no gate verde do CI. DoD#4 N/A: a task não altera UI. DoD#8 aberto até o merge (não fiz merge, conforme combinado). Container task042 (porta 55458) derrubado; albionhub-dev e task037 intactos; worktree mantido.
<!-- SECTION:NOTES:END -->
