...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Rota própria para o catálogo de roles com item na navegação de gestão
- [ ] #2 Templates continua funcionando sem o catálogo embutido
- [ ] #3 Permissões e estados vazios mantidos
<!-- AC:END -->
