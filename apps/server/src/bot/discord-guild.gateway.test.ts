...
describe("BotModule.register", () => {
  it("exige DISCORD_MEMBER_ROLE_ID", () => {
    expect(() => BotModule.register({ DISCORD_TOKEN: "a.b.c", GUILD_ID: GUILD, DISCORD_MEMBER_ROLE_ID: undefined, DISCORD_STAFF_CHANNEL_ID: "423456789012345678", DISCORD_EVENTS_CHANNEL_ID: "523456789012345678", DISCORD_WAITING_VOICE_CHANNEL_ID: "623456789012345678", DISCORD_EVENT_CATEGORY_ID: "723456789012345678" })).toThrow("DISCORD_MEMBER_ROLE_ID");
  });
});
