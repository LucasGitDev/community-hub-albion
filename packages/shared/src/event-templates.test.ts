...
const template = (over: Record<string, unknown> = {}) => ({
  ...
  maxPartySize: 9,
  roles: [
    { roleId: TANK, slots: 1, buffunfaMin: "0", buffunfaMax: "0" },
    { roleId: HEAL, slots: 3, buffunfaMin: "0", buffunfaMax: "0" },
  ],
  ...over,
});
...
describe("eventTemplateInputSchema (TASK-020 AC#2, Q8)", () => {
  ...
  it.each([
    ...
    [{ roles: [{ roleId: TANK, slots: 0, buffunfaMin: "0", buffunfaMax: "0" }] }, "Vagas precisa ser pelo menos 1"],
    [{ roles: [{ roleId: TANK, slots: 1.5, buffunfaMin: "0", buffunfaMax: "0" }] }, "inteiro"],
    [{ roles: [{ roleId: "x", slots: 4, buffunfaMin: "0", buffunfaMax: "0" }] }, "Role inválida"],
    [{ roles: [{ roleId: TANK, slots: 2, buffunfaMin: "0", buffunfaMax: "0" }, { roleId: TANK, slots: 2, buffunfaMin: "0", buffunfaMax: "0" }] }, "Cada role aparece uma vez"],
    ...
    [{ roles: [{ roleId: TANK, slots: 10, buffunfaMin: "0", buffunfaMax: "0" }] }, "acima do máximo de 9"],
    [{ roles: [{ roleId: TANK, slots: 3, buffunfaMin: "0", buffunfaMax: "0" }] }, "abaixo do mínimo de 4"],
